package com.xin.framework.utils.common.assist;
...
import com.xin.framework.utils.common.utils.ShellUtil;
...
public class SilentInstaller {
    ...
    public int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        Log.e(TAG,
                "uninstallSilent successMsg:" + commandResult.responseMsg +
    ...
    public int installSilent(Context context, String filePath, String pmParams) {
        ...
        Log.e(TAG,
                "installSilent successMsg:" + commandResult.responseMsg +
                        ", ErrorMsg:" + commandResult.errorMsg);
        if (commandResult.errorMsg == null) {
