package com.xin.framework.utils.android.async;

import android.os.Handler;
import android.os.Looper;


import com.xin.framework.utils.android.logger.Log;
 ...
 * @param <ResultT>
 */
public abstract class SafeAsyncTask<ResultT> implements
                                             Callable<ResultT> {
    ...
    protected void onThrowable(Throwable t) throws RuntimeException {
        Log.e(t,
                  "Throwable caught during background processing",
                  t);
    }
    ...
    public static class Task<ResultT> implements
                                      Callable<Void> {
        ...
        public Void call() throws Exception {
            try {
                ...
                try {
                    ...
                    // logged but ignored
                    Log.e(f,"SafeAsyncTask.call()");
                }
            } finally {
                //noinspection ThrowFromFinallyBlock,ThrowFromFinallyBlock
                doFinally();
            }
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        exceptions[0] = e;
                        Log.e(e,"SafeAsyncTask.postToUiThreadAndWait()");
                    } finally {
                        latch.countDown();
                    }
                }
