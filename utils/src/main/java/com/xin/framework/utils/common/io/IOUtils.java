...
import com.xin.framework.utils.common.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.xin.framework.utils.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.xin.framework.utils.common.io.stream.ByteArrayOutputStream output = new com.xin.framework.utils.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
    ...
    public static byte[] toByteArray(URLConnection urlConn) throws IOException {
        ...
        try {
            ...
            com.xin.framework.utils.android.logger.Log.e(e,"");
        }finally {
            inputStream.close();
        }
        return new byte[0];
