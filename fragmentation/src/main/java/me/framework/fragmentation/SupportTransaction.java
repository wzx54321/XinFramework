...
/**
 * Add some action when calling {@link FragmentSupport#start(FragmentSupport)
...
public abstract class SupportTransaction {
     ...
     *            fragment with {@link FragmentSupport#findFragment(String)}
    ...
    /**
     * Can replace {@link FragmentSupport#startWithPop(FragmentSupport)}
     *
     ...
     */
    public abstract <T extends FragmentSupport> T commit();

    /**
     * Add some action when calling {@link FragmentSupport#start(FragmentSupport)
     * or SupportActivity/SupportFragment.startXXX()}
     */
    final static class SupportTransactionImpl<T extends FragmentSupport> extends SupportTransaction {
        ...
        @Override
        public SupportTransaction setLaunchMode(@FragmentSupport.LaunchMode int launchMode) {
