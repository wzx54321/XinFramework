...
public class VisibleDelegate {
    ...
    private FragmentSupport mSupportFragment;

    public VisibleDelegate(FragmentSupport fragment) {
            ...
            if (fragmentManager != null) {
                ...
                if (childFragments != null) {
                    for (Fragment child : childFragments) {
                        if (child instanceof FragmentSupport && !child.isHidden() && child.getUserVisibleHint()) {
                            ((FragmentSupport) child).getVisibleDelegate().dispatchSupportVisible(visible);
                        }
                    }
                }
            }
