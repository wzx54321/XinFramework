...
public class FragmentSupport extends RxFragment implements ISupportFragment {
    ...
    protected ActivitySupport _mActivity;
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof ActivitySupport) {
            this._mActivity = (ActivitySupport) activity;
    ...
    @Override
    public void start(final FragmentSupport toFragment, @LaunchMode final int launchMode) {
    ...
    @Override
    public void replaceFragment(FragmentSupport toFragment, boolean addToBack) {
     ...
     */
    @Override
    public FragmentSupport getTopChildFragment() {
     ...
     */
    @Override
    public FragmentSupport getPreFragment() {
     ...
     */
    @Override
    public <T extends FragmentSupport> T findChildFragment(Class<T> fragmentClass) {
        return mFragmentationDelegate.findStackFragment(fragmentClass, null, getChildFragmentManager());
    }

    @Override
    public <T extends FragmentSupport> T findChildFragment(String fragmentTag) {
        FragmentationDelegate.checkNotNull(fragmentTag, "tag == null");
    ...
    private void dispatchFragmentLifecycle(int lifecycle, Bundle bundle, boolean visible) {
        ...
        _mActivity.dispatchFragmentLifecycle(lifecycle, FragmentSupport.this, bundle, visible);
    }
}
